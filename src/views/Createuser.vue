        ...
        <div class="card-body px-lg-5 py-lg-5">
          <form role="form" class="text-primary">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <label for="clientType">Função</label>
                <div>
                  <select
                    v-model="clientType"
                    id="clientType"
                    ...
                    required
                  >
                    <option disabled value="">Selecione o cargo do trabalhador</option>
                    <option selected value="Empresa">Operador</option>
                    <option value="Individual">Gestor</option>
                  </select>
                </div>
              </div>
            </div>

...
const Useres = () => {
  ...
  const typeOfClient = clientConfig.singular
            ...
            <Row >
              <Col md="4">
                <Button className="m0 text-uppercase" color="danger" to="/operator/clients" type="button" tag={Link}  >
                  <i className="fas fa-arrow-left"></i>voltar</Button>
              </Col>
            </Row>
            <CardHeader className="text-center border-0 pt-2 pt-md-4 pb-0 pb-md-0">
              <h2 className="mb-0 text-default">Registar Cliente Singular</h2>

              <Button block className="my-5 text-uppercase" size="lg" color="info" to="/operator/editsingular" type="button" tag={Link}  >
                <i className="fas fa-male pr-1 text-uppercase"></i>Editar Cliente</Button>
            </CardHeader>
            <CardBody>

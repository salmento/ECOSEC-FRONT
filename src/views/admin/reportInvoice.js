...
const Invoices = () => {
    ...
    const listinvoiceNotPayed = async () => {
        ...
        try {
            const response = await axios.get(`order/listnotpayedinvoices?initialDate=${initialDate}&finalDate=${finalDate}&addressId=${addressId}`,
                {
                    ...
                    <Col className="order-xl-1 mb-5 mt-7 mb-xl-0" >
                        <Card className="card-profile shadow">
                            ...
                            <CardHeader className="text-center border-0 pt-2 pt-md-4 pb-0 pb-md-0">
                                <h3 className="mb-0 text-default">Facturas pendentes</h3>
                            </CardHeader>
                            <CardBody>
                                            ...
                                            >
                                                <thead className="text-white bg-info p-1 h1">
                                                    <tr>
                                                        ...
                                                        <th className="p-1 pl-2" scope="col">Documento</th>
